...
- ae24f18: - hardhat v3 migration (https://github.com/scaffold-eth/scaffold-eth-2/pull/1272)
...
- 08d8153: - update vercel CLI to ~51.2.1 for yarn vercel:login (https://github.com/scaffold-eth/scaffold-eth-2/pull/1269)
...
- 0dcdbca: - Add agent skills: x402, drizzle-neon, subgraph (https://github.com/scaffold-eth/scaffold-eth-2/pull/1240)
  - Trim tier 2+3 skills to eval-proven content (83% reduction) (https://github.com/scaffold-eth/scaffold-eth-2/pull/1245)
- ac2b0b7: support "." as directory path

## 2.0.10

### Patch Changes

- 589ea94: - configure burner visibility (https://github.com/scaffold-eth/scaffold-eth-2/pull/1239)

## 2.0.9

### Patch Changes

- 95df93d: - add skill package (https://github.com/scaffold-eth/scaffold-eth-2/pull/1235)
  - Add EIP-712 and SIWE agent skills (https://github.com/scaffold-eth/scaffold-eth-2/pull/1237)

## 2.0.8

### Patch Changes

- 97ebc8d: - Adds bundled skills (erc-20, erc-721, eip-5792, ponder) under `templates/base/.agents/skills/`
  - Updates `AGENTS.md.template.mjs` with "Skills & Agents Index" section listing all available skills and agents
...
- bf418b2: add EFP extension
- 0371efe: - up solidity version and scaffold-ui (https://github.com/scaffold-eth/scaffold-eth-2/pull/1218)
