...
| Array, add new items    | `const arrWithAdditionalItems = ${stringify(deepMerge(['a', 'b'], arrayToSpread[0]))};`         | `const arrayToSpread = ["Spread", "This"]`                 | `const arrWithAdditionalItems = ["a", "b", "Spread", "This"]`                           |
